...
Environment create_env_string_typed_imp(
...
Environment populate_env_string_typed_imp(
  Environment env,
  CharacterVector names,
  bindrcpp::GETTER_FUNC_STRING_TYPED fun,
  bindrcpp::PAYLOAD payload
...
Environment create_env_symbol_typed_imp(
  CharacterVector names,
...
Environment populate_env_symbol_typed_imp(
  Environment env,
  CharacterVector names,
  bindrcpp::GETTER_FUNC_SYMBOL_TYPED fun,
  bindrcpp::PAYLOAD payload
...
Environment create_env_string_wrapped_imp(
  CharacterVector names,
...
Environment create_env_symbol_wrapped_imp(
  CharacterVector names,
...
Environment populate_env_symbol_wrapped_imp(
  Environment env,
  CharacterVector names,
  bindrcpp::GETTER_FUNC_SYMBOL_WRAPPED fun,
  List payload
...
Environment create_env_string_imp(
  CharacterVector names,
  bindrcpp::GETTER_FUNC_STRING fun,
  bindrcpp::PAYLOAD payload,
  Environment enclos
) {
...
Environment populate_env_string_imp(
  Environment env,
  CharacterVector names,
  bindrcpp::GETTER_FUNC_STRING fun,
  bindrcpp::PAYLOAD payload
...
Environment create_env_symbol_imp(
  CharacterVector names,
  bindrcpp::GETTER_FUNC_SYMBOL fun,
  bindrcpp::PAYLOAD payload,
  Environment enclos
) {
...
Environment populate_env_symbol_imp(
  Environment env,
  CharacterVector names,
  bindrcpp::GETTER_FUNC_SYMBOL fun,
  bindrcpp::PAYLOAD payload
